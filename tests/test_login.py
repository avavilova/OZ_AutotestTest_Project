...
def test_try_to_log_in_with_invalid_email(login_page):
...
def test_try_to_log_in_with_invalid_password(login_page):
...
def test_try_to_log_in_without_phone_number(login_page):
